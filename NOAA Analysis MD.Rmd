...
ggplot(worstevents,aes(x=EVTYPE,y=value,fill=variable))+geom_bar(stat="identity",position="stack") + theme(axis.text.x = element_text(angle=90,hjust = 1)) + xlab("Extreme Weather Event") + ylab("Occurence per Event")
```
